 ...
 *
 * now with emoji! (manual port of https://github.com/chjj/marked/pull/238)
 */
...
;(function() {
  ...
  function emojiDefaultTemplate(emoji) {
    return '<img src="'
      + 'https://raw.githubusercontent.com/WebpageFX/emoji-cheat-sheet.com/master/public/graphics/emojis/'
      ...
      + escape(emoji)
      + ':"'
      + ' class="emoji" height="50" width="50" style="vertical-align: text-top">';
  }
